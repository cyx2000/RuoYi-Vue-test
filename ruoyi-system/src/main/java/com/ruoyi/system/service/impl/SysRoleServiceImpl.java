...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public TableDataInfo getPagedListResp(SysRole role) {
        return roleRepository.getPagedListResp(role);
    }
    ...
    public int insertRoleMenu(SysRole role)
    {
        ...
        if (list.size() > 0)
        {
            rows = roleMenuRepository.batchRoleMenu(list);
        }
        return rows;
    }
    ...
    public int insertRoleDept(SysRole role)
    {
        ...
        if (list.size() > 0)
        {
            rows = roleDeptRepository.batchRoleDept(list);
        }
        return rows;
    }
    ...
    public int insertAuthUsers(Long roleId, Long[] userIds)
    {
        ...
        return userRoleRepository.batchUserRole(list);
    }
}
